...
Format may be PDB or MMCIF"""
    ...
    def _fixGluBaLikeResidues(self, pdbIn, pdbOut):
        ...
        with open(pdbIn, "r") as f:
            for line in f:
                ...
                # -------- SEQRES --------
                    ...
                    chainID_field = line[10:12].strip()
        ...
        if modified:
            logger.info("Detected errors in PDB format. Its now valid.")
