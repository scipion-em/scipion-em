...
class ProtProjectionEditor(EMProtocol):
    """
    Protocol to edit the proejction directions of all the items of a set using a formula.
    This could be useful for aplying geometrical transformation to a set of particles.
    ...
    * convert between tetrahedral symmetries
    ...
    def _defineParams(self, form):
        ...
        line.addParam('zt', params.FloatParam, default=0,
                      ...
                      help="Z dim ")
        # rotate vector
        line = form.addLine('rotate around vector',
        ...
        line.addParam("originSymmetryGroupI", params.EnumParam,
        ...
        line.addParam("targetSymmetryGroupI", params.EnumParam,
                      condition="operation==%d" % self.CHOICE_ICOSAHEDRAL,
                      label="target",
        ...
        line.addParam("originSymmetryGroupD", params.EnumParam,
        ...
        line.addParam("targetSymmetryGroupD", params.EnumParam,
                      condition="operation==%d" % self.CHOICE_DIHEDRAL,
                      label="target",
                      help = "Target symmetry. ",
                      choices=list(self.DIHEDRAL_SYM_NAME.values()),
        ...
        line = form.addLine('Tetrahedral symmetry',
                            ...
                            help='convert between dihedral symmetries')
        line.addParam("originSymmetryGroupT", params.EnumParam,
        ...
        line.addParam("targetSymmetryGroupT", params.EnumParam,
                      condition="operation==%d" % self.CHOICE_TETRAHEDRAL,
                      label="target",
                      help = "Target symmetry. ",
                      choices=list(self.TETRAHEDRAL_SYM_NAME.values()),
